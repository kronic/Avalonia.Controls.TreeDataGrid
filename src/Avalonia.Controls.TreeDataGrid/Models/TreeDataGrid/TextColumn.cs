...
namespace Avalonia.Controls.Models.TreeDataGrid
{
    ...
    public class TextColumn<TModel, TValue> : ColumnBase<TModel, TValue>, ISearchableTextColumn<TModel>
        where TModel : class
    {
        ...
        string? ISearchableTextColumn<TModel>.ResolveStingValueFromModel(TModel model)
        {
